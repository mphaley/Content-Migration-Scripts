...
do
	...
	then
		...
		#generate new token
		new_token1=$(curl -X POST https://halyard.showpad.biz/api/v2/oauth2/token -H 'Authorization: Basic TXXXXXXXXXXXXXXX' -H 'content-type: multipart/form-data' -F grant_type=refresh_token -F refresh_token="$refresh_token_1" | tr -d ' ' )
