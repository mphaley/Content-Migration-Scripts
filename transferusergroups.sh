...
alltags_raw=$(curl -X GET --header 'Accept: application/json' --header 'Authorization: Bearer '"$access_token_1"'' 'https://halyard.showpad.biz/api/v3/usergroups.json?limit=1000')
...
do
	...
	#curl -X POST --header 'Content-Type: application/x-www-form-urlencoded' --header 'Accept: application/json' --header 'Authorization: Bearer '"$access_token_2"'' -d 'name='"$thistag"'' 'https://avanosmedical.showpad.biz/api/v2/usergroups.json'
	
	curl -X POST --header 'Content-Type: application/x-www-form-urlencoded' --header 'Accept: application/json' --header 'Authorization: Bearer '"$access_token_2"'' -d 'name='"$thistag"'' 'https://avanosmedical.showpad.biz/api/v3/usergroups.json'
